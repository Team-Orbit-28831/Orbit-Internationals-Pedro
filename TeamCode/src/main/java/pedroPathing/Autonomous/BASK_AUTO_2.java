...
@Autonomous(name = "CORRECTED Basket Auto - RED", group = "Autonomous")
public class BASK_AUTO_2 extends OpMode {
    ...
    // Score Pose
    private final Pose scorePose = new Pose(127.05882352941177, 19.25133689839572, Math.toRadians(135));

    private final Pose pickup1Pose = new Pose(127.05882352941177, 24.44919786096257, Math.toRadians(180));

    private final Pose pickup2Pose = new Pose(118.58823529411764, 12.898395721925137, Math.toRadians(180));
    private final Pose parkPose = new Pose(131.10160427807486, 45.240641711229955, Math.toRadians(21));
