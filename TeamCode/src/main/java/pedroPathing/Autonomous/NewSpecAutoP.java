...
@Autonomous(name = "Auto_Chamber_Pedro_PathOnly new lol", group = "Examples")
public class NewSpecAutoP extends OpMode {
    ...
    private PathChain aheadAB, grab1Ready, grabPickup1, grab2Ready,grabPickup2,grab3Ready,grabPickup3,firstCollect;
...
//                .build();
        grab1Ready = follower.pathBuilder()
                .addPath(new BezierCurve(new Point((new Pose(30, convertOffset(77.7)))), new Point(new Pose(5.4, convertOffset(20.9))), new Point(new Pose(69.7, convertOffset(39.3))), new Point(new Pose(61.5, convertOffset(27.3)))))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .setPathEndVelocityConstraint(75)
                .setZeroPowerAccelerationMultiplier(8.5)
                .build();
        ...
        grabPickup1 = follower.pathBuilder()
                .addPath(new BezierLine(new Point((new Pose(61.5, convertOffset(27.3)))), new Point(new Pose(13.7, convertOffset(27.6)))))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .setPathEndVelocityConstraint(75)
                .setZeroPowerAccelerationMultiplier(8.5)
                .build();
        ...
        grab2Ready = follower.pathBuilder()
                .addPath(new BezierLine(new Point((new Pose(6.5, convertOffset(27.6)))), new Point(new Pose(70.4, convertOffset(25.7)))))
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .setPathEndVelocityConstraint(75)
                .setZeroPowerAccelerationMultiplier(8.5)
                .build();
        grabPickup2 = follower.pathBuilder()
                .addPath(
                        new BezierCurve(
                                new Point(70.4, convertOffset(25.7), Point.CARTESIAN),
        ...
        grab3Ready = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                ...
                                new Point(71.918, convertOffset(7.235), Point.CARTESIAN)
                        )
                )
                .setConstantHeadingInterpolation(Math.toRadians(0))
                .setPathEndVelocityConstraint(75)
        ...
        firstCollect = follower.pathBuilder()
                .addPath(
                        new BezierLine(
                                ...
                                new Point(14, convertOffset(23.5), Point.CARTESIAN)
                        )
                )
